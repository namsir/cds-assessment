                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="Title" class="form-control @error('Title') is-invalid @enderror"
                                   id="companyname" value="{{ old('Title') }}">
                            @error('Title')
